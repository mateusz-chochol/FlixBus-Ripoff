...
- general:
  ...
  - create low resolution version of the background picture, download it first, blur it in CSS, in the background download full version and then switch between them