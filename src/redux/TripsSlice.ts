...
// fake API calls
const getAllTrips = () => tripsInitialState;
const getTripsByDepartureId = (id: number) => tripsInitialState.list.filter(trip => trip.startLocationId === id);
const getTripsByDestinationId = (id: number) => tripsInitialState.list.filter(trip => trip.endLocationId === id);
const getTripsByDepartureAndDestinationIds = (departureId: number, destinationId: number) =>
  tripsInitialState.list.filter(trip => trip.startLocationId === departureId && trip.endLocationId === destinationId);
